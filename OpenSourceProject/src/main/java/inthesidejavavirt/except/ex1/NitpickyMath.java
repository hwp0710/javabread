package inthesidejavavirt.except.ex1;
...
class NitpickyMath {
	...
	static int add(int a, int b) throws OverflowException, UnderflowException {
		long longA = (long) a;
		long longB = (long) b;
		long result = a + b;
	...
	static int subtract(int minuend, int subtrahend) throws OverflowException, UnderflowException {
	...
	static int multiply(int a, int b) throws OverflowException, UnderflowException {
		long longA = (long) a;
		long longB = (long) b;
		long result = a * b;
		if (result > Integer.MAX_VALUE) {
	...
	static int divide(int dividend, int divisor) throws OverflowException, DivideByZeroException {
