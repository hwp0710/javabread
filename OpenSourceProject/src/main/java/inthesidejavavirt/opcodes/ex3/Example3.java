package inthesidejavavirt.opcodes.ex3;
...
// On CD-ROM in file opcodes/ex3/Example3.java
class Example3 {

    public static void main(String[] args) {

        System.out.println(Surprise.surpriseTheProgrammer(true));
        System.out.println(Surprise.surpriseTheProgrammer(false));
    }
}
