package inthesidejavavirt.security.ex2;
...
// On CD-ROM in file security/ex2/QuestionWriter.java

import inthesidejavavirt.security.ex2.com.artima.security.doer.Doer;
import java.io.FileWriter;
import java.io.IOException;

public class QuestionWriter implements Doer {
	...
	public void doYourThing() {
		...
		try {
			...
			try {
				fw.write("Too what extent does complexity threaten security?");
			} catch (IOException e) {
			} finally {
				try {
					fw.close();
