...
import concurrencyinpractice.net.jcip.examples.DynamicOrderDeadlock.Account;
import concurrencyinpractice.net.jcip.examples.DynamicOrderDeadlock.DollarAmount;
