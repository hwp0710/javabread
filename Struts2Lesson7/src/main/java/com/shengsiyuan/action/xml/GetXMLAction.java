...
public class GetXMLAction extends ActionSupport
{
	...
	{
		People people1 = createPerson1();
		
		People people2 = createPerson2();
		
		Document document = createXML(people1, people2);
	...
	private Document createXML(People people1, People people2) {
